...
//    }
    ...
    public function createDriver($request)
    {
        ...
        if ($request->start_date == null && $request->end_date !=null){
            ...
            if ($parse_end_date->lt($parse_created_at)){
                return ResponseService::responseJsonError(Response::HTTP_METHOD_NOT_ALLOWED, trans('drivers.end_date_not_after_or_equal_now'));
            }
        }
    ...
    public function updateDriver($request, $id)
    {
        ...
        if ($request->start_date != $driver->start_date) {

...
class CashInCreateTest extends TestCase
{
    /**
    ...
    public function testCashInCreateSuccess()
    {
        ...
        $this->actingAs($user)->json('post', 'api/cash-in', [
            'token' => $token,
            'customer_id' => 1,
            'cash_in' => 1000,
            'payment_method' => 1,
    ...
    /////////Create Start//////////
    public function testCashInCreateCustomer_idEmpty()
    {
        $dayForCourse6 = Carbon::now()->addDay()->format("Y-m-d");
        $course = Course::create([
            "customer_id"=> 5,
    ...
    public function testCashInCreateCash_inEmpty()
    {
        $dayForCourse6 = Carbon::now()->addDay()->format("Y-m-d");
        $course = Course::create([
            "customer_id"=> 5,
    ...
    public function testCashInCreatePayment_methodEmpty()
    {
        $dayForCourse6 = Carbon::now()->addDay()->format("Y-m-d");
        $course = Course::create([
            "customer_id"=> 5,
    ...
    public function testCashInCreatePayment_dateEmpty()
    {
        $dayForCourse6 = Carbon::now()->addDay()->format("Y-m-d");
        $course = Course::create([
            "customer_id"=> 5,

...
class DriverCourseListSalesTest extends TestCase
{
    /**
...
//    public function testDriverCourseListSalesSuccess()
//    {
//        $user = User::where('user_code', '1122')->first();
//        $this->actingAs($user);
...
//    }
    ...
    public function testDriverCourseListSalesSuccess()
    {
        $user = User::where('user_code', '=', '1122')->first();
        $token = \JWTAuth::fromUser($user);
        $this->actingAs($user)->json('get', 'api/driver-course/sales-list', [
            'token' => $token,
            'month_year' => "2023-07",
        ])->assertStatus(CODE_SUCCESS);
    }
...
//    }
//
//    public function testDriverCourseListSalesWrongSortby()
//    {
//        $user = User::where('user_code', '=', '1122')->first();
//        $token = \JWTAuth::fromUser($user);
//        $this->actingAs($user)->json('get', 'api/driver-course', [
...
//    }
//
//    public function testDriverCourseListSalesSortbyButNotField()
//    {
//        $user = User::where('user_code', '=', '1122')->first();
//        $token = \JWTAuth::fromUser($user);
//        $this->actingAs($user)->json('get', 'api/driver-course', [
...
//    }
    ...
    public function testDriverCourseListSalesMonth_yearEmpty()
    {
        $user = User::where('user_code', '=', '1122')->first();
        $token = \JWTAuth::fromUser($user);
        $this->actingAs($user)->json('get', 'api/driver-course/sales-list', [
    ...
    public function testDriverCourseListSalesWrongMonth_yearFormat()
    {
        $user = User::where('user_code', '=', '1122')->first();
        $token = \JWTAuth::fromUser($user);
        $this->actingAs($user)->json('get', 'api/driver-course/sales-list', [
    ...
    public function testDriverCourseListSalesExport()
    {
        $user = User::where('user_code', '=', '1122')->first();
        $token = \JWTAuth::fromUser($user);
        $this->actingAs($user)->json('get', 'api/driver-course/sales-list', [

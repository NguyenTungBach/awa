export default {
	...
	MESSAGE_APP: {
		...
		DRIVER_MANAGEMENT_CREATE_SUCCESS: '従業員を作成しました。',
		DRIVER_MANAGEMENT_UPDATE_SUCCESS: '従業員を更新しました。',
		DRIVER_MANAGEMENT_DELETE_SUCCESS: '従業員を削除しました。',
		DRIVER_MANAGEMENT_CLICK_TAB_COURSE: '入力されていない項目があります。',
		DRIVER_MANAGEMENT_VALIDATE_REQUIRED: '入力されていない項目があります。',
		DRIVER_MANAGEMENT_VALIDATE_DRIVER_CODE: '社員番号は半角数字15桁以内で入力してください。',
		DRIVER_MANAGEMENT_VALIDATE_DRIVER_NAME: '氏名は20文字以内で入力してください。',
		DRIVER_COURSE_MANAGEMENT_CREATE_SUCCESS: '従業員走行可能コースを作成しました。',
		DRIVER_COURSE_MANAGEMENT_UPDATE_SUCCESS: '従業員走行可能コースを更新しました。',
		DRIVER_COURSE_MANAGEMENT_DELETE_SUCCESS: '従業員走行可能コースを削除しました。',
		DRIVER_MANAGEMENT_VALIDATE_GRADE: '等級は半角英数字10桁以内で入力してください。',

		COURSE_MANAGEMENT_CREATE_SUCCESS: '運行情報を作成しました。',
		COURSE_MANAGEMENT_UPDATE_SUCCESS: '運行情報を更新しました。',
		COURSE_MANAGEMENT_DELETE_SUCCESS: '運行情報を削除しました。',
		COURSE_MANAGEMENT_VALIDATE_REQUIRED: '入力されていない項目があります。',
		COURSE_MANAGEMENT_VALIDATE_GROUP: 'グループ項目はアルファベット両方を選択してください。',
		COURSE_MANAGEMENT_VALIDATE_COURSE_CODE: '運行情報IDは半角英数字15桁以内で入力してください。',
		COURSE_MANAGEMENT_VALIDATE_COURSE_NAME: '運行情報名は30文字以内で入力してください。',
		...
		SCHEDULE_MANAGEMENT_CREATE_SUCCESS: '運行情報の作成が完了しました',
		SCHEDULE_MANAGEMENT_UPDATE_SUCCESS: '運行情報の更新が完了しました',
		SCHEDULE_MANAGEMENT_DELETE_SUCCESS: '運行情報の削除が完了しました',
		...
		SCHEDULE_CREATE_SUCCESS: '運行情報スケジュールの作成が成功しました',
		...
		SCHEDULE_IMPORT_FAIL: '運行情報ID {listCourse} はインポートできませんでした。',
		...
		// CASH MANAGEMENT
		CASH_OUT_DELETE_SUCCESS: '出金情報の削除が完了しました',
		CASH_OUT_CREATE_SUCCESS: '出金情報の作成が完了しました',
		CASH_OUT_UPDATE_SCUCCESS: '出金情報の更新が完了しました',

		CASH_IN_CREATE_SUCCESS: '入金情報の作成が完了しました',
		CASH_IN_DELETE_SUCCESS: '入金情報の削除が完了しました',
		CASH_IN_UPDATE_SCUCCESS: '入金情報の更新が完了しました',
	},
	APP: {

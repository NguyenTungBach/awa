export default {
	...
	LIST_SHIFT: {
		...
		TABLE_VEHICLE_NUMBER: 'Vehicle name',
		TABLE_PAYMENT_MONTHLY_AMOUNT: 'Monthly amount',
		TABLE_EXPENSE_ID: 'Driver ID',
		TABLE_EXPENSE_TYPE: 'Driver type',
		TABLE_EXPENSE_NAME: 'Driver name',
		FREE: 'Free',

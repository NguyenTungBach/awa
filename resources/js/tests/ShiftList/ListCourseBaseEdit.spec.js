...
import CourseBaseEdit from '@/pages/ShiftManagement/ListShift/CourseBase/edit';
...
describe('TEST COMPONENT EDIT LIST COURSE BASE', () => {
	test('Check render page', () => {
		const localVue = createLocalVue();
		const wrapper = mount(CourseBaseEdit, {
			localVue,
			store,
			router,
			computed: {
	...
	test('Check render title page', () => {
		...
		expect(TITLE.text()).toEqual('LIST_SHIFT.TITLE_COURSE_BASE');
